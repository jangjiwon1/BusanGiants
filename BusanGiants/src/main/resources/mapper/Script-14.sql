...
CREATE TABLE BESTPLAYER(
	...
	UP_BEST_PLAYER1_IMG		VARCHAR(255),		# NOT NULL
	UP_BEST_PLAYER2_IMG		VARCHAR(255),		# NOT NULL
	PLAYER1_UUID	VARCHAR(255),		# NOT NULL UNIQUE
	PLAYER2_UUID	VARCHAR(255),		# NOT NULL UNIQUE
